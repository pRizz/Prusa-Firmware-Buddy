...
bool StepAndCheckState(MMU2::ProtocolLogic &pl, std::string_view rx_content, PST pl_state, PSC pl_scope, MMU2::StepStatus step_status, std::string_view tx_content);
...
void QueryRegisters(MMU2::ProtocolLogic &pl, PSC scope = PSC::Idle, PSC terminal_scope = PSC::Idle, MMU2::StepStatus terminal_status = MMU2::Finished, const char *terminal_msg = "");
