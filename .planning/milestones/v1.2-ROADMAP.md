...
v1.2 executed the real external evidence and acceptance flows created in v1.1, closed upstream evidence flow into final readiness, preserved fail-closed quick behavior, and kept reference demotion as a separate explicit maintainer approval.
...
- **v1.2 Cutover Evidence Execution and Acceptance** - Phases 23-30, shipped 2026-07-02. Goal: execute real external evidence gates, record maintainer acceptance decisions, and produce a final readiness packet without automatic reference demotion.
...
### v1.2 Cutover Evidence Execution and Acceptance (Shipped)
