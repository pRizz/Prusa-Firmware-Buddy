# Requirements Archive: v1.0 Rust Port Evidence Foundation

**Archived:** 2026-06-15
**Status:** SHIPPED

This file is the archived v1.0 requirements record. A fresh `.planning/REQUIREMENTS.md`
will be created when the next milestone is defined.
