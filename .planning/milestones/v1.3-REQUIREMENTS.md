# Requirements Archive: v1.3 Cutover Approval and Reference Demotion Trial

**Archived:** 2026-08-02
**Status:** SHIPPED

The live `.planning/REQUIREMENTS.md` is removed after milestone archival so the next milestone can define a fresh requirements surface with `/gsd-new-milestone`.
