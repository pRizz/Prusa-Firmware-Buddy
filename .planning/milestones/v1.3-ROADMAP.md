...
v1.3 consumed sanitized evidence and explicit maintainer decisions through a fail-closed cutover workflow, preserved reference demotion as a separate authorization, eliminated temporary owned file-length debt, and closed terminal milestone metadata with a passed audit.
