...
Phases 13 through 20 of v1.1 are complete. CI can run the aggregate cutover verifier, simulator, hardware, live-service, release-candidate, retained-code, aggregate evidence, and release-artifact gates through Python, Bazel, and `just` facades. Phase 20 replaced the empty release-candidate artifact identity with a Phase-20-backed release-environment input manifest, release-result manifest generation, signing/provenance/comparison guards, clean code review, and explicit smoke-proof rejection.
...
*Last updated: 2026-06-21 after Phase 20 completion*
