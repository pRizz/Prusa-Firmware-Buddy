...
Phases 13 and 14 of v1.1 are complete. CI can now run the aggregate cutover verifier, write machine-readable evidence, retain redacted artifacts, and expose the checks through Python, Bazel, and `just phase13-verify`. Simulator evidence now has a Phase-14-owned contract, deterministic dry-run artifacts, explicit real-run prerequisites, overclaim guards, and `just phase14-verify`.
...
*Last updated: 2026-06-17 after Phase 14 completion*
