...
1. **[RESOLVED] Should Phase 20 validation drift be included in Phase 22 cleanup?**
   ...
   - Selected answer: Include Phase 20 validation drift in Phase 22 cleanup as an explicit adjacent correction, not as silent debt. The Phase 22 contract and verifier must cover `.planning/phases/20-release-candidate-artifact-production/20-VALIDATION.md` alongside Phase 14-18 validation files, because Phase 20 verification passed and the roadmap requires Phase 19-22 directory consistency. [VERIFIED: `.planning/phases/20-release-candidate-artifact-production/20-VERIFICATION.md`; `.planning/ROADMAP.md`; `.planning/phases/22-evidence-metadata-reconciliation/22-CONTEXT.md`]
   - Resolution marker: RESOLVED in planning by adding the `validation-phase20-adjacent-drift` correction row and Phase 20 validation wiring/readiness checks to Phase 22 plans. [VERIFIED: `.planning/phases/22-evidence-metadata-reconciliation/22-01-PLAN.md`; `.planning/phases/22-evidence-metadata-reconciliation/22-02-PLAN.md`; `.planning/phases/22-evidence-metadata-reconciliation/22-03-PLAN.md`]

2. **[RESOLVED] Should the original audit file be overwritten or superseded?**
   ...
   - Selected answer: Preserve the old audit as historical evidence until the documented audit rerun supersedes it. Phase 22 first writes source-backed audit-readiness output under `build/ci-evidence/phase22/`, then the final Phase 22 plan runs the milestone audit workflow after `just phase22-verify`; the rerun report must show `status: passed` or only deliberate documented non-blocking debt. [VERIFIED: `.planning/phases/22-evidence-metadata-reconciliation/22-CONTEXT.md`; `/Users/peterryszkiewicz/.codex/get-shit-done/workflows/audit-milestone.md`]
   - Resolution marker: RESOLVED in planning by adding a final audit rerun task to `22-03-PLAN.md` instead of hand-editing the old audit findings. [VERIFIED: `.planning/phases/22-evidence-metadata-reconciliation/22-03-PLAN.md`]
...
- Resolved questions: HIGH - Phase 20 validation drift is included in Phase 22 cleanup, and the old audit is preserved as historical input until superseded by Phase 22 readiness output plus a documented milestone audit rerun. [VERIFIED: `.planning/phases/20-release-candidate-artifact-production/20-VALIDATION.md`; `.planning/phases/22-evidence-metadata-reconciliation/22-CONTEXT.md`; `.planning/phases/22-evidence-metadata-reconciliation/22-03-PLAN.md`]
