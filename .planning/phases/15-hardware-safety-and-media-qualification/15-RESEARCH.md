...
| Storage media | `hard-usb-fatfs-media`, `hard-internal-littlefs-media`, `hard-eeprom-config-store`, `hard-semihosting-debug-media` | `tools/bazel/manifests/phase7_storage_media.json#filesystem-usb-fatfs`, `#filesystem-internal-littlefs`, `#storage-driver-eeprom`, `#filesystem-semihosting` | HARD-01, HARD-03 [VERIFIED: tools/bazel/manifests/phase7_storage_media.json] |
...
1. **Which physical devices and operators are available for later real hardware runs?** [VERIFIED: .planning/phases/15-hardware-safety-and-media-qualification/15-CONTEXT.md]
   ...
   - What's unclear: The actual lab inventory and operator identities were not available in this research session. [VERIFIED: environment availability audit]
...
2. **How granular should storage-media variants be?** [VERIFIED: tools/bazel/manifests/phase7_storage_media.json]
   ...
   - What's unclear: Specific removable-media brands, capacities, filesystem variants, and degradation cases are not named in current manifests. [VERIFIED: tools/bazel/manifests/phase7_storage_media.json]
...
3. **Should `blocked-hardware-unavailable` be separate from `manual-hardware-required`?** [VERIFIED: .planning/phases/15-hardware-safety-and-media-qualification/15-CONTEXT.md]
   ...
   - What's unclear: The exact status vocabulary is delegated to the agent. [VERIFIED: .planning/phases/15-hardware-safety-and-media-qualification/15-CONTEXT.md]
